...
## Notice: The current version uses MultKAN instead of KAN. The APIs are almost the same. More documents soon, a quick tutorial on MultKAN [here](https://github.com/KindXiaoming/pykan/blob/master/tutorials/MultKAN_tutorial.ipynb).
