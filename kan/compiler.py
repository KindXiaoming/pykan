...
def expr2kan(input_variables, expr, grid=5, k=3, auto_save=True, seed=0, base_fun='silu'):
    ...
    model = MultKAN(width=width, mult_arity=mult_arities, grid=grid, k=k, auto_save=False, seed=seed, base_fun=base_fun)
